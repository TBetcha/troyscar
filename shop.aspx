<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="shop.aspx.cs" Inherits="troyscar.shop" %>
    ...
    <div class ="container">
       ...
       <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="502px" DataKeyNames="ID">
        ...
        <SortedDescendingHeaderStyle BackColor="#7E0000" />
           ...
           <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString5 %>" ProviderName="<%$ ConnectionStrings:ConnectionString5.ProviderName %>" SelectCommand="SELECT [ID], [Make], [Model], [Yr], [Color], [Mileage], [Type], [Location], [Price], [Picture] FROM [Sales] WHERE ([Type] = ?) ORDER BY [Price]">
               <SelectParameters>
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataSourceID="SqlDataSource2" CellPadding="4" Height="50px" Width="125px" DataKeyNames="ID" >
      ...
      <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
        ...
        <RowStyle BackColor="White" ForeColor="#330099" />
           ...
           <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString6 %>" ProviderName="<%$ ConnectionStrings:ConnectionString6.ProviderName %>" SelectCommand="SELECT [ID], [Make], [Model], [Yr], [Mileage], [Color], [Type], [Location], [Price], [Picture] FROM [Sales] WHERE ([ID] = ?)">
               <SelectParameters>
